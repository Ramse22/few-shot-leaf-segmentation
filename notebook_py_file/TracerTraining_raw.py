...
if plot:
    ...
    for i in range(64):
        ...
        plt.plot(
            window_size / 2 + output[0], window_size / 2 - output[1], "r-", linewidth=1
        )
...
save_name = f"leaf_tracer_{window_size}_raw"
...
# model summary
torchinfo.summary(cnn, input_size=(1, 4, window_size, window_size), device=device)
